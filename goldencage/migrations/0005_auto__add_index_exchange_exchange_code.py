...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'Exchange', fields ['exchange_code']
        db.create_index(u'goldencage_exchange', ['exchange_code'])


    def backwards(self, orm):
        # Removing index on 'Exchange', fields ['exchange_code']
        db.delete_index(u'goldencage_exchange', ['exchange_code'])
    ...
    models = {
        ...
        u'goldencage.exchange': {
            ...
            'create_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'exchange_code': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '50', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
