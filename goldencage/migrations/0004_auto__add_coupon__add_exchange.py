...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Coupon'
        db.create_table(u'goldencage_coupon', (
            ...
            ('exchange_style', self.gf('django.db.models.fields.CharField')(default=u'wechat', max_length=10)),
            ('exchange_config', self.gf('jsonfield.fields.JSONField')(null=True, blank=True)),
            ('limit', self.gf('django.db.models.fields.IntegerField')(default=1)),
        ))
        db.send_create_signal(u'goldencage', ['Coupon'])

        # Adding model 'Exchange'
        db.create_table(u'goldencage_exchange', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('coupon', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['goldencage.Coupon'])),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('exchange_code', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True)),
        ...
        db.send_create_signal(u'goldencage', ['Exchange'])


    def backwards(self, orm):
        # Deleting model 'Coupon'
        db.delete_table(u'goldencage_coupon')

        # Deleting model 'Exchange'
        db.delete_table(u'goldencage_exchange')
    ...
    models = {
        ...
        u'goldencage.coupon': {
            ...
            'exchange_config': ('jsonfield.fields.JSONField', [], {'null': 'True', 'blank': 'True'}),
            'exchange_style': ('django.db.models.fields.CharField', [], {'default': "u'wechat'", 'max_length': '10'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'key': ('django.db.models.fields.CharField', [], {'max_length': '50'}),
            'limit': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        u'goldencage.exchange': {
            'Meta': {'object_name': 'Exchange'},
            'cost': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'coupon': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['goldencage.Coupon']"}),
            'create_time': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'exchange_code': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
