...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Exchange.exchange_user'
        db.add_column(u'goldencage_exchange', 'exchange_user',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Exchange.exchange_user'
        db.delete_column(u'goldencage_exchange', 'exchange_user')
    ...
    models = {
        ...
        u'goldencage.exchange': {
            ...
            'exchange_user': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
